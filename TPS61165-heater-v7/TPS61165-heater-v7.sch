...
$EndDescr
$Comp
L TPS61165-heater-v5-rescue:TPS61165-0JLC-TPS61165-heater-rescue U1
U 1 1 61311BD9
P 3650 3500
...
$EndComp
$Comp
L 0JLC-6:USB_C_KoreanHroparts_6P J1
U 1 1 6133BFA9
P 1750 1900
...
$EndComp
$Comp
L 0JLC-6:KAQY212A U2
U 1 1 61369742
P 7750 5000
F 0 "U2" V 7704 5188 50  0000 L CNN
F 1 "KAQY212A" V 7795 5188 50  0000 L CNN
F 2 "0my_footprints:SMD-4_L4.6-W6.4-P2.54-LS10.0-BR" H 7550 4800 50  0001 L CIN
F 3 "https://datasheet.lcsc.com/lcsc/1811151652_Cosmo-Electronics-KAQY212A_C194713.pdf" H 7700 5000 50  0001 L CNN
F 4 "C194713" H 7750 5000 50  0001 C CNN "LCSC"
F 5 "KAQY212A" H 7750 5000 50  0001 C CNN "MPN"
	1    7750 5000
	-1   0    0    1   
$EndComp
...
U 1 1 61380CBC
P 8050 5250
F 0 "R2" V 7843 5250 50  0000 C CNN
F 1 "390" V 7934 5250 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 7980 5250 50  0001 C CNN
F 3 "~" H 8050 5250 50  0001 C CNN
F 4 "C23151" H 8050 5250 50  0001 C CNN "LCSC"
F 5 "0603WAF3900T5E" H 8050 5250 50  0001 C CNN "MPN"
	1    8050 5250
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 61383DC9
P 8050 4900
F 0 "#PWR0114" H 8050 4650 50  0001 C CNN
...
U 1 1 62879353
P 8100 3150
F 0 "U3" H 8100 3731 50  0000 C CNN
F 1 "INA219AxD" H 8100 3640 50  0000 C CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 8900 2800 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/ina219.pdf" H 8450 3050 50  0001 C CNN
	1    8100 3150
	1    0    0    -1  
$EndComp
Text Notes 4150 6300 0    100  ~ 0
from v0 to v5\nreplace INA226 with INA229\nAdd zener diode for offset\nremove mmcx\nmove switch so that it is parallel to output\n\n\n
Wire Wire Line
	7700 3050 6450 3050
Wire Wire Line
	6450 3050 6450 3950
...
U 1 1 6289D7DE
P 5650 4650
F 0 "D2" H 5650 4434 50  0000 C CNN
F 1 "BZT52Bxx" H 5650 4525 50  0000 C CNN
F 2 "Diode_SMD:D_SOD-123" H 5650 4475 50  0001 C CNN
F 3 "https://diotec.com/tl_files/diotec/files/pdf/datasheets/bzt52b2v4.pdf" H 5650 4650 50  0001 C CNN
	1    5650 4650
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 628A29E9
P 5650 5050
F 0 "JP3" H 5650 5285 50  0000 C CNN
F 1 "Jumper_2_Open" H 5650 5194 50  0000 C CNN
F 2 "Jumper:SolderJumper-2_P1.3mm_Open_RoundedPad1.0x1.5mm" H 5650 5050 50  0001 C CNN
